...
namespace Fabio.SharpTools.Search
{
    ...
    /// </summary>
    public sealed class AhoCorasick : IStringSearchAlgorithm
    {
        #region Objects
        ...
        public Dictionary<int, string> FindAll(string text)
        {
            ...
            while (index < text.Length)
            {
                ...
                foreach (string found in ptr.Results)
                    ret.Add(index - found.Length + 1, found);
                index++;
            }
            return ret;
        }
        ...
        public Dictionary<int, string> FindFirst(string text)
        {
            Dictionary<int, string> ret = new Dictionary<int, string>(1);
            TreeNode ptr = _root;
            int index = 0;
